...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/opt/hostedtoolcache/Python/3.9.5/x64/bin',
 'BINLIBDEST': '/opt/hostedtoolcache/Python/3.9.5/x64/lib/python3.9',
 'BLDLIBRARY': '-L. -lpython3.9',
 'BLDSHARED': 'gcc -pthread -shared '
              '-Wl,--rpath=/opt/hostedtoolcache/Python/3.9.5/x64/lib '
              '-Wl,--rpath=/opt/hostedtoolcache/Python/3.9.5/x64/lib',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIGURE_CFLAGS_NODIST': '-std=c99 -Wextra -Wno-unused-result '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '-Wl,--rpath=/opt/hostedtoolcache/Python/3.9.5/x64/lib',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIG_ARGS': "'--prefix=/opt/hostedtoolcache/Python/3.9.5/x64' "
                "'--enable-shared' '--enable-optimizations' "
                "'--enable-loadable-sqlite-extensions' "
                "'LDFLAGS=-Wl,--rpath=/opt/hostedtoolcache/Python/3.9.5/x64/lib'",
 'CONFINCLUDEDIR': '/opt/hostedtoolcache/Python/3.9.5/x64/include',
 'CONFINCLUDEPY': '/opt/hostedtoolcache/Python/3.9.5/x64/include/python3.9',
 'COREPYTHONPATH': '',
 ...
 'CXX': 'g++ -pthread',
 'DESTDIRS': '/opt/hostedtoolcache/Python/3.9.5/x64 '
             '/opt/hostedtoolcache/Python/3.9.5/x64/lib '
             '/opt/hostedtoolcache/Python/3.9.5/x64/lib/python3.9 '
             '/opt/hostedtoolcache/Python/3.9.5/x64/lib/python3.9/lib-dynload',
 'DESTLIB': '/opt/hostedtoolcache/Python/3.9.5/x64/lib/python3.9',
 'DESTPATH': '',
 'DESTSHARED': '/opt/hostedtoolcache/Python/3.9.5/x64/lib/python3.9/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/opt/hostedtoolcache/Python/3.9.5/x64/include '
                   '/opt/hostedtoolcache/Python/3.9.5/x64/include '
                   '/opt/hostedtoolcache/Python/3.9.5/x64/include/python3.9 '
                   '/opt/hostedtoolcache/Python/3.9.5/x64/include/python3.9',
 'INCLUDEDIR': '/opt/hostedtoolcache/Python/3.9.5/x64/include',
 'INCLUDEPY': '/opt/hostedtoolcache/Python/3.9.5/x64/include/python3.9',
 ...
 'LDVERSION': '3.9',
 'LIBC': '',
 'LIBDEST': '/opt/hostedtoolcache/Python/3.9.5/x64/lib/python3.9',
 'LIBDIR': '/opt/hostedtoolcache/Python/3.9.5/x64/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/opt/hostedtoolcache/Python/3.9.5/x64/lib/pkgconfig',
 'LIBPL': '/opt/hostedtoolcache/Python/3.9.5/x64/lib/python3.9/config-3.9-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/opt/hostedtoolcache/Python/3.9.5/x64/lib/python3.9',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 1,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/opt/hostedtoolcache/Python/3.9.5/x64/share/man',
 ...
 'PY_CORE_LDFLAGS': '-Wl,--rpath=/opt/hostedtoolcache/Python/3.9.5/x64/lib '
                    '-Wl,--rpath=/opt/hostedtoolcache/Python/3.9.5/x64/lib',
 'PY_CPPFLAGS': '-I. -I./Include',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-Wl,--rpath=/opt/hostedtoolcache/Python/3.9.5/x64/lib '
               '-Wl,--rpath=/opt/hostedtoolcache/Python/3.9.5/x64/lib',
 'PY_LDFLAGS_NODIST': '',
 ...
 'SCRIPTDIR': '/opt/hostedtoolcache/Python/3.9.5/x64/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '@SGI_ABI@',
 'SHELL': '/bin/sh',
 ...
 'datarootdir': '/opt/hostedtoolcache/Python/3.9.5/x64/share',
 'exec_prefix': '/opt/hostedtoolcache/Python/3.9.5/x64',
 'prefix': '/opt/hostedtoolcache/Python/3.9.5/x64',
 'srcdir': '.'}
